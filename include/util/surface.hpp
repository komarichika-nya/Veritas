...
template<typename T>
struct surface{
vec3<T,P>pos{0,0,0};vec3<T,V>face_normal{0,0,0};vec3<T,V>shading_normal{0,0,0};T u=fsytd::lim<T>::max(),v=fsytd::lim<T>::max();vec3<T,V>dpu{0,0,0},dpv{0,0,0};vec3<T,V>wo{0,0,0};
HD surface();
